...
- direct product, variant, brand, category subtree, price-list entry, and inventory-balance mutations now enqueue internal storefront projection refresh requests
...
- broader dependency fan-out is still pending for market assignment and inventory-location market assignment changes
