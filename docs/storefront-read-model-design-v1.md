...
- the documented direct dependency fan-outs for Phase 3 are now covered; remaining hardening is operational, such as coalescing, observability, and retry behavior
